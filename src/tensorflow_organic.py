...
def nn_plot(acc, loss, testacc, testloss, details):
    ...
    input:  list of test accuracy, test loss, validation accuracy, validation loss, 
            and details about Neural Net to be included in title
...
if __name__ == '__main__':
    ...
    #---    Run neural nets & graph
    loss1, val_loss1, acc1, val_acc1 = nn_1layer(3, 'relu')
    nn_plot(acc1, loss1, val_acc1, val_loss1, '1 Layer, and ReLU')

    loss2, val_loss2, acc2, val_acc2 = nn_1layer(3, 'swish')
    nn_plot(acc2, loss2, val_acc2, val_loss2, '1 Layer, and Swish')
